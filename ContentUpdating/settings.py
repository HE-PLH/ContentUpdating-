"""
Django settings for ContentUpdating project.
...
SECRET_KEY = 'django-insecure-gkuuo%%1*8(xt4n*^biq^*xk3d(k!gu7yfun8l9p$pmbpvxwbw'
...
ROOT_URLCONF = 'ContentUpdating.urls'
...
WSGI_APPLICATION = 'ContentUpdating.wsgi.application'
